...
function redraw()
  ...
  elseif current_page == 2 then
    ...
    screen.font_size(9); screen.level(8); screen.move(64, 56); screen.text_center("ARP RATE: " .. arp_rate_names[arp_rate_idx])
    screen.level(4); screen.font_size(7); screen.move(64, 63); screen.text_center("E2=BPM  E3=ARP RATE")
  elseif current_page == 3 then
    screen.font_size(10); screen.level(12); screen.move(64, 18); screen.text_center("THEME / VIBE")
    ...
    screen.level(4); screen.font_size(7); screen.move(64, 63); screen.text_center("E2=THEME  K3=REGEN GRID")
  end
  screen.update()
end
